...
/// </summary>
internal class InboxRouteInterceptor<TDbContext>(InboxAcceptor<TDbContext> inboxAcceptor)
    ...
    where TDbContext : DbContext, IInboxDbContext
{
    ...
    {
        var outcome = await inboxAcceptor.AcceptAsync(
            body,
            properties,
            transportName,
            channelName,
        ...
        return new RouteInterceptResult(
            HandlersAccepted: outcome is InboxAcceptOutcome.Accepted or InboxAcceptOutcome.Duplicate
        );
    }
}
