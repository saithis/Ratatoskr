...
public class EfCoreMetricsBackgroundServiceTests
{
    ...
    public async Task UpdateMetricsAsync_AccuratelyCountsPendingAndPoisonedMessages()
    {
        ...
        dbContext.AddRange(outPending1, outPending2, outPoisoned, outProcessed);
        ...
        dbContext.AddRange(inPending1, inPending2, inPending3, inPoisoned1, inPoisoned2, inCompleted);
