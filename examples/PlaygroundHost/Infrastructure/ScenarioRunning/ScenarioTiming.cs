...
{
    public static readonly TimeSpan OrderEventuallyLong = TimeSpan.FromSeconds(90);

    public static readonly TimeSpan OrderEventuallyMedium = TimeSpan.FromSeconds(60);

    public static readonly TimeSpan PollLoopLong = TimeSpan.FromSeconds(90);
    ...
    public static readonly TimeSpan ReplaySettleDelay = TimeSpan.FromSeconds(5);

    public static readonly TimeSpan EfCoreActivitySettleDelay = TimeSpan.FromSeconds(6);
}
